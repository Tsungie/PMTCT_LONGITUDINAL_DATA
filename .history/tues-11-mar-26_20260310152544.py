...
df_optimized = pd.read_excel("uploads/Optimized Sites.xlsx")
df_mothers = pd.read_csv("uploads/DATA SET WITH TRACE OF THE MOTHER.csv", encoding="latin1")
df_infants = pd.read_csv("uploads/DATA SET WITH NO TRACEABLE MOTHERS.csv", encoding="latin1")
