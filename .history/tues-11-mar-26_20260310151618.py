...
df_optimized = pd.read_csv("uploads/Optimized Sites.xlsx")
df_mothers = pd.read_csv("uploads/DATA SET WITH TRACE OF THE MOTHER.csv")
df_infants = pd.read_csv("uploads/DATA SET WITH NO TRACEABLE MOTHERS.csv")
...
art_initiated = len(
    hiv_pos_infants_df[hiv_pos_infants_df["infant_date_of_art_initiation"].notnull()]
)
